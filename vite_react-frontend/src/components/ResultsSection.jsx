    ...
    >
      <div className="container">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 className="section-title">STRIDE Threat Analysis Results</h2>
          <p className="section-subtitle">Identified STRIDE security vulnerabilities</p>
        </motion.div>
                  ...
                  {threats.length === 0 ? (
                    ...
                    threats.map((threat, index) => (
                      ...
                      >
                        ...
                        <td>
                          <motion.span className="threat-type">{threat.type}</motion.span>
                        </td>
